...
export default function Home() {
    ...
    return (
        <div className="flex flex-col items-center gap-8">
            <h1 className="text-2xl font-bold mb-2">Gerenciador de Códigos de Barras</h1>
            
            <div className="flex flex-col md:flex-row gap-8 w-full max-w-2xl">
                {/* Card 1 */}
                <div className="bg-white rounded-xl shadow-md p-8 flex flex-col items-center hover:shadow-lg transition-shadow cursor-pointer flex-1"onClick={() => Navigate("/cadastrarCOD")}>
                ...
                {/* Card 2 */}
                <div className="bg-white rounded-xl shadow-md p-8 flex flex-col items-center hover:shadow-lg transition-shadow cursor-pointer flex-1 "onClick={() => Navigate("/pesquisarCOD")}>
